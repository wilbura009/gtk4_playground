...
# define SECTION __attribute__ ((section (".gresource.viewmd"), aligned (8)))
#else
# define SECTION
#endif

static const SECTION union { const guint8 data[1067]; const double alignment; void * const ptr;}  viewmd_resource_data = {
  ...
  "\274\000\000\000\153\245\277\023\003\000\000\000\274\000\000\000"
  "\007\000\114\000\304\000\000\000\310\000\000\000\260\267\044\060"
  "\001\000\000\000\310\000\000\000\006\000\114\000\320\000\000\000"
  "\324\000\000\000\010\125\071\027\002\000\000\000\324\000\000\000"
  "\020\000\166\000\350\000\000\000\052\004\000\000\057\000\000\000"
  "\001\000\000\000\157\162\147\057\003\000\000\000\166\151\145\167"
  "\155\144\057\000\004\000\000\000\147\156\157\155\145\057\000\000"
  "\002\000\000\000\166\151\145\167\155\144\055\167\151\156\144\157"
  "\167\056\165\151\000\000\000\000\062\003\000\000\000\000\000\000"
  ...
  "\154\141\163\163\075\042\126\151\145\167\155\144\127\151\156\144"
  ...
  "\055\150\145\151\147\150\164\042\076\063\060\060\074\057\160\162"
  "\157\160\145\162\164\171\076\012\012\040\040\074\057\164\145\155"
  "\160\154\141\164\145\076\012\012\040\040\074\155\145\156\165\040"
  "\151\144\075\042\160\162\151\155\141\162\171\137\155\145\156\165"
  "\042\076\012\040\040\040\040\074\163\145\143\164\151\157\156\076"
  ...
  "\171\145\163\042\076\137\113\145\171\142\157\141\162\144\040\123"
  "\150\157\162\164\143\165\164\163\074\057\141\164\164\162\151\142"
  ...
  "\042\171\145\163\042\076\137\101\142\157\165\164\040\103\157\163"
  "\155\151\143\141\147\145\156\144\141\074\057\141\164\164\162\151"
  ...
  "\156\165\076\012\012\074\057\151\156\164\145\162\146\141\143\145"
  "\076\012\000\000\050\165\165\141\171\051" };

static GStaticResource static_resource = { viewmd_resource_data.data, sizeof (viewmd_resource_data.data) - 1 /* nul terminator */, NULL, NULL, NULL };

G_MODULE_EXPORT
GResource *viewmd_get_resource (void);
GResource *viewmd_get_resource (void)
{
...
#ifdef G_DEFINE_CONSTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_CONSTRUCTOR_PRAGMA_ARGS(viewmdresource_constructor)
#endif
G_DEFINE_CONSTRUCTOR(viewmdresource_constructor)
#ifdef G_DEFINE_DESTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_DESTRUCTOR_PRAGMA_ARGS(viewmdresource_destructor)
#endif
G_DEFINE_DESTRUCTOR(viewmdresource_destructor)

#else
#warning "Constructor not supported on this compiler, linking in resources will not work"
#endif

static void viewmdresource_constructor (void)
{
  g_static_resource_init (&static_resource);
}

static void viewmdresource_destructor (void)
{
